...
export default function WhatsAppButton() {
  ...
  return (
    <div style={{ position:'fixed', bottom:28, right:28, zIndex:500, display:'flex', alignItems:'flex-end', flexDirection:'column', gap:10 }}>
      {/* Tooltip */}
      {hovered && (
        <div style={{
          background:'#0A0A0A', color:'#FFFFFF', padding:'8px 14px',
          fontFamily:"'Barlow Condensed',sans-serif", fontSize:13, fontWeight:600, letterSpacing:'.04em',
